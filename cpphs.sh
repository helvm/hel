...
mkdir -p hs/src/HelVM/Hel/MiniHaskell/
...
mkdir -p hs/src/HelVM/Hel/Compiler/Compiler/
mkdir -p examples/compiler/standalone/

cpphs --noline --strip -DEMBEDDED   examples/compiler/original/typically.hs > hs/src/HelVM/Hel/Compiler/Compiler/Typically.hs
cpphs --noline --strip -DSTANDALONE examples/compiler/original/typically.hs > examples/compiler/standalone/typically.hs

cpphs --noline --strip -DEMBEDDED   examples/compiler/original/classy.hs > hs/src/HelVM/Hel/Compiler/Compiler/Classy.hs
cpphs --noline --strip -DSTANDALONE examples/compiler/original/classy.hs > examples/compiler/standalone/classy.hs

cpphs --noline --strip -DEMBEDDED   examples/compiler/original/barely.hs > hs/src/HelVM/Hel/Compiler/Compiler/Barely.hs
cpphs --noline --strip -DSTANDALONE examples/compiler/original/barely.hs > examples/compiler/standalone/barely.hs

cpphs --noline --strip -DEMBEDDED   examples/compiler/original/effectively.hs > hs/src/HelVM/Hel/Compiler/Compiler/Effectively.hs
